...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--warning", type=int, default=30, help="Warning threshold in minutes (default=30)")
    parser.add_argument("-c", "--critical", type=int, default=90, help="Warning threshold in minutes (default=90)")
